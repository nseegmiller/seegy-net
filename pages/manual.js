...
import profilePic from '../assets/scotland-2024.jpg'
      ...
      <main>
        ...
        <div>
          <p>
            ...
            I considered myself a passionate user. I love games, mobile apps, and web development.
        ...
        <div>
          <p>
            I describe my style as "dangerous transparency." I will always share with you everything I'm allowed to and
          ...
          <p>
            Secondly, I expect everyone to do their best, do what they say, and to not fail silently. I don't presume people
        ...
        <div>
          <p>
            I have strong opinions about most things and will nearly always share them, but I don't expect to always get my way.
        ...
        <div>
          <p>
            I am always hungry for feedback and never get as much as I want. I ask everyone around me (peers, direct reports, skip levels, my manager) for
          ...
          <p>
            I usually prefer to be recognized in private, and I don't always do a good job of figuring out how others like to be recognized and doing it that way. Please
        ...
        <div>
          <p>
            I want to work with people I like, I think are smart, and that I get along with. When all of our interactions are transactional, it's harder to have
        ...
        <div>
          ...
          <ul>
            <li><b>Chat:</b> This is always the best way to contact me and will result in the quickest response,
        ...
        <div>
          ...
          <p>
            I will have regular staff meetings with everyone in my org. This may be as frequently as once per week. The primary purpose
